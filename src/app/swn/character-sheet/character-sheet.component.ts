...
import { Character, Attributes, Weapon, Armor, Skill, Goal, Focus, DynamicCharacterValueProvider } from "../models/index";
...
export class CharacterSheetComponent implements OnInit {
  ...
  public json() {
    let ignoreList = ['dynamics', 'extra'];
    function replacer(key, value) {
      if (ignoreList.indexOf(key) > -1) return undefined;
      else return value;
    }
    return JSON.stringify(this.character, replacer, 2);
  }
  ...
  onSave() {
    this.downloadFile(this.json(), this.character.name + "_" + Date.now() + ".json");
  }
  ...
  private onloaded(e: ProgressEvent) {
    let json = (<FileReader>e.target).result;
  ...
  private initCharacter() {
    ...
    this.character.goals[0].details = "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.";
    ...
    this.character.skills[0].details = "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.";
    this.character.skills[1] = new Skill();
    this.character.skills[1].name = "Lead";
    this.character.skills[1].details = "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.";
    this.character.skills[2] = new Skill();
    this.character.skills[2].name = "Notice";
    this.character.skills[2].details = "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.";
    this.character.skills[3] = new Skill();
    this.character.skills[3].name = "Punch";
    this.character.skills[3].details = "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.";
    this.character.skills[4] = new Skill();
    this.character.skills[4].name = "Stab";
    this.character.skills[4].details = "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.";
    this.character.skills[5] = new Skill();
    this.character.skills[5].name = "Talk";
    this.character.skills[5].details = "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.";
    this.character.skills[6] = new Skill();
    this.character.skills[6].name = "Survival";
    this.character.skills[6].details = "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.";
    this.character.skills[7] = new Skill();
    this.character.skills[7].name = "remaining";
    this.character.skills[7].details = "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.";
